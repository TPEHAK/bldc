...
float hw_get_PAS_torque(void) {
	return app_adc_get_voltage2()*1000; // app_adc_get_voltage2()*1000 placed instead of luna_canbus_get_PAS_torque() to read the torque value (voltage) from the pin PB0 of STM32 MCU
}
